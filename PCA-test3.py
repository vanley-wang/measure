...
features_list = [
    ...
    'Cyst_Thick_Avg_1', 'Cyst_Thick_Avg_4', 'Number_1', 'Number_2', 'Number_4', 'Roughness_All', 'Short_Axis_Avg_2', 'Short_Axis_Avg_3',
    'Sphericity_Avg_1', 'Sphericity_Avg_3', 'Sphericity_Avg_4', 'Surface_Avg_3', 'Volume_Fill_Avg_1', 'Volume_Fill_Avg_4'
